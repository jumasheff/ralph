#!/bin/bash
# Ralph Wiggum - Long-running AI agent loop (OpenCode version)
...
if is_termux; then
  echo "Warning: Termux detected. Consider using ./ralph-opencode-termux.sh instead."
  echo "         It includes Termux-specific compatibility fixes."
  echo ""
fi
